# DFS - Depth First Seach - tìm kiếm theo chiều sâu_Stack
graph = {
  '5' : ['3','7'],
  '3' : ['2', '4'],
  '7' : ['8'],
...
# Driver Code
print("TÌM KIẾM THEO DFS")
dfs(visited, graph, '5')


# BFS -Breadth Frist Search-  tìm kiếm theo chiều rộng_ queue
graph = {
  '5' : ['3','7'],
  '3' : ['2', '4'],
  '7' : ['8'],
...
# Driver Code
print("TÌM KIẾM THEO BFS")
bfs(visited, graph, '5')    # function calling


# tìm kiếm A* tìm kiếm trên map 
...
#  python Thuatoantimkiem_DFS_BFS_A.py -c 25 -r 25 -s 1 -q 3 -e 23 -t 21 -l true -> gán số hàng cột... trên map 
# để chạy bài A* -> 1. cd  D:\BaiTap\AI 2. cop code trên để chạy 